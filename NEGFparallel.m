function [ out ] = NEGFparallel( A1,B1,Cntct1PlcSlct,B2,H,contact1,contact2,A2,dE,t,h,Cntct2PlcSlct)
%UNTITLED Summary of this function goes here
%   Detailed explanation goes here
    parfor ihere = 1:101%E = -.15 : dE : .15
        %if (E~=0)
        E = -0.5+(ihere-1)*dE;
    ...
    %         Ec(index) = E;
            fprintf(1,'T for E=%f is currently computed\n',E);
